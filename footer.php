...
<div class="container-fluid"style="max-width: ">
  ...
  <div class="row" style="background-color:#202020;  ">
    <div class="col-sm-4 margin-b-30 text-center" style="margin-top: 40px;" >
     <a href="#">
  ...
  <div class="rounded-social-buttons" style="margin: 50px; ">
...
.rounded-social-buttons .social-button.instagram:hover, .rounded-social-buttons .social-button.instagram:focus {
  ...
  border-color: #cd486b;
    ...
    <div class="col-sm-12 text-center" style="color: #f1f1f0; margin: 20px; font-size: 18px;" >
       &copy; 2018 Drishti-SVNIT. All Rights Reserved
    </div>
  </div>
</div>
